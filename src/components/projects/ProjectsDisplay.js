...
const ProjectsDisplay = () => {
  return (
    <div className="columns projectsPage">
      <div className="column is-12-mobile is-offset-2-tablet is-4-tablet is-offset-3-desktop is-2-desktop">
      ...
      <div className="column is-12-mobile is-offset-2-tablet is-4-tablet is-2-desktop">
        <ProjectsLink to="/projects/Recyclo" text="Recyclo">
          <img src={require('../../images/recyclo.png')}/>
        </ProjectsLink>
      </div>
      <div className="column is-12-mobile is-4-tablet is-offset-3-desktop is-2-desktop">
